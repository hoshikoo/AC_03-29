...
public class Capitals {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Please input the name of a state: ");
        String stateName = input.nextLine();

        // If the user enters the name of a state, print out,
        //   The capital of (state) is (capital).

        if (getCapitals().get(stateName)!=null){
            String capital = getCapitals().get(stateName);
            System.out.print("The capital of "+stateName+" is "+capital);
        }
        ...
        //   (name) is not a state!
            ...
            System.out.print(stateName+" is not a state!");
        }
